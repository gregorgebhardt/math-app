<template>
  <div class="addition-quiz">
    <div class="quiz-header">
      <IconAddition :size="36" class="quiz-header-icon" />
      <h2 class="quiz-header-title">Additionsaufgaben</h2>
    </div>
...
import IconAddition from '../icons/IconAddition.vue'
...
function generateProblem() {
  const a = Math.floor(Math.random() * (props.maxVal - 1)) + 1  // 1..maxVal-1
  const b = Math.floor(Math.random() * (props.maxVal - a)) + 1  // 1..maxVal-a
  const c = a + b
